...
import { gs4SyllabusSections } from "@/data/gs4-syllabus";

export const metadata: Metadata = {
  title: "GS Paper 4 Syllabus | Syllabus & Pattern | Career Prepp",
  description:
    "Free UPSC GS Paper IV syllabus breakdown — ethics, attitude, aptitude, emotional intelligence, moral thinkers, public administration ethics, and probity in governance.",
};
...
function sectionStats(section: (typeof gs4SyllabusSections)[number]) {
  const topicCount = section.blocks.reduce((n, b) => n + b.topics.length, 0);
  const pointCount = section.blocks.reduce(
    (n, b) => n + b.topics.reduce((m, t) => m + t.points.length, 0),
    0,
  );
  return { units: section.blocks.length, topics: topicCount, points: pointCount };
}

export default function GsPaper4Page() {
  const totalTopics = gs4SyllabusSections.reduce(
      ...
      <main className="flex-1">
        <section className="gs1-hero relative min-h-[88svh] overflow-hidden bg-black lg:min-h-[92svh]">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=2400&h=1350&q=90"
              alt="Ethics and values study theme for GS Paper IV"
              fill
              priority
              quality={90}
          ...
          <div className="relative z-10 mx-auto flex min-h-[88svh] max-w-7xl flex-col justify-end px-6 pb-16 pt-28 sm:pb-20 lg:min-h-[92svh] lg:justify-center lg:px-8 lg:pb-24 lg:pt-24">
            <div className="gs1-hero-content max-w-3xl">
              ...
              <p className="gs1-hero-kicker">
                Syllabus &amp; Pattern · GS Paper IV
              </p>

              <h1 className="gs1-hero-title">
                Ethics, attitude, integrity &amp; probity — mapped for Mains.
              </h1>

              <p className="gs1-hero-text">
                A free, exam-ready syllabus atlas for UPSC CSE Mains GS Paper IV,
                structured from the GS 4 syllabus file with full topic
                checklists and case-study practice cues.
              </p>

              <div className="gs1-hero-actions">
                <a href="#gs4-map" className="hero-btn-primary footer-cta-shine">
                  Explore syllabus map
                  <IconArrow className="ml-2 inline h-4 w-4" />
                </a>
                <a
                  href="/file/GS-PAPER-4-SYLLABUS.docx"
                  download
        ...
        <nav className="gs1-rail sticky top-16 z-30 border-b border-line bg-white/92 backdrop-blur-md sm:top-[4.75rem]">
          <div className="mx-auto flex max-w-7xl items-center gap-3 overflow-x-auto px-6 py-3.5 lg:px-8">
            ...
            {gs4SyllabusSections.map((section, i) => (
              <a
                key={section.id}
                href={`#${section.id}`}
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
              <div className="section-head section-head-dark max-w-2xl">
                ...
                <h2 className="section-title">
                  Nine chapters. Full GS Paper IV ethics syllabus map.
                </h2>
                <p className="section-text">
                  Skim the atlas, then open a chapter for unit cards and nested
                  checklist points taken directly from the syllabus file.
                </p>
              </div>
              ...
              <div className="gs1-preview-stats">
                <div>
                  <p className="gs1-stat-value">
                    {String(gs4SyllabusSections.length).padStart(2, "0")}
                  </p>
            ...
            <div className="gs1-preview-list mt-12">
              {gs4SyllabusSections.map((section, i) => {
                ...
                const { units, topics, points } = sectionStats(section);
                return (
                  <a
                    key={section.id}
                    href={`#${section.id}`}
                  ...
                  >
                    ...
                    <span className="gs1-preview-meta">
                      <span>
                        {units} units · {topics} topics · {points} points
                      </span>
        ...
        {gs4SyllabusSections.map((section, sIndex) => {
          const Icon = sectionIcons[sIndex] ?? IconLayers;
          const isAlt = sIndex % 2 === 1;
          const wide = section.blocks.length === 1;
          ...
          return (
            ...
            >
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div
                  className={`mt-12 grid gap-5 ${wide ? "" : "lg:grid-cols-2"}`}
                >
        ...
        <section className="border-t border-line bg-black py-20 lg:py-28">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div className="section-head section-head-dark max-w-xl">
              ...
              <h2 className="section-title">
                Pair GS Paper IV with GS Paper 3 and Current Affairs.
              </h2>
              <p className="section-text">
                Use free syllabus pages together — ethics frameworks work best
                with real governance and social examples.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/syllabus/gs-paper-2" className="hero-btn-ghost">
                GS Paper 2
                <span className="hero-btn-arrow" aria-hidden>
                  →
                </span>
