...
import { geographySyllabusSections } from "@/data/geography-syllabus";

export const metadata: Metadata = {
  title: "Geography Syllabus | Syllabus & Pattern | Career Prepp",
  description:
    "Free UPSC Geography syllabus map — world & Indian physical geography, human geography, and map work.",
};
...
function sectionStats(section: (typeof geographySyllabusSections)[number]) {
  const points = section.blocks.reduce((n, b) => n + b.points.length, 0);
  return { units: section.blocks.length, points };
}

export default function GeographySyllabusPage() {
  const totalPoints = geographySyllabusSections.reduce(
      ...
      <main className="flex-1">
        <section className="gs1-hero relative min-h-[88svh] overflow-hidden bg-black lg:min-h-[92svh]">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=2400&h=1350&q=90"
              alt="World map — Indian and world geography study theme"
              fill
              priority
              quality={90}
          ...
          <div className="relative z-10 mx-auto flex min-h-[88svh] max-w-7xl flex-col justify-end px-6 pb-16 pt-28 sm:pb-20 lg:min-h-[92svh] lg:justify-center lg:px-8 lg:pb-24 lg:pt-24">
            <div className="gs1-hero-content max-w-3xl">
              ...
              <p className="gs1-hero-kicker">
                Syllabus &amp; Pattern · Geography
              </p>

              <h1 className="gs1-hero-title">
                Indian &amp; world geography — free syllabus map.
              </h1>

              <p className="gs1-hero-text">
                Physical geography, India’s physiography and climate, human
                geography, and map work — structured checklists from the
                Geography syllabus file.
              </p>
              ...
              <div className="gs1-hero-actions">
                ...
                <a
                  href="/file/GEOGRAPHY-SYLLABUS.docx"
                  download
        ...
        <nav className="gs1-rail sticky top-16 z-30 border-b border-line bg-white/92 backdrop-blur-md sm:top-[4.75rem]">
          <div className="mx-auto flex max-w-7xl items-center gap-3 overflow-x-auto px-6 py-3.5 lg:px-8">
            ...
            {geographySyllabusSections.map((section, i) => (
              <a
                key={section.id}
                href={`#${section.id}`}
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
              <div className="section-head section-head-dark max-w-2xl">
                ...
                <h2 className="section-title">
                  Four chapters. Full Geography syllabus map.
                </h2>
                <p className="section-text">
                  Skim the atlas, then open a chapter for expandable topic
                  checklists taken directly from the Geography syllabus file.
                </p>
              </div>
              ...
              <div className="gs1-preview-stats">
                <div>
                  <p className="gs1-stat-value">
                    {String(geographySyllabusSections.length).padStart(2, "0")}
                  </p>
        ...
        {geographySyllabusSections.map((section, sIndex) => {
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs tracking-[0.14em] text-muted uppercase">
                        ...
                        {String(geographySyllabusSections.length).padStart(
                          2,
                          "0",
                        )}
                      </p>
        ...
        <section className="border-t border-line bg-black py-20 lg:py-28">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div className="section-head section-head-dark max-w-xl">
              ...
              <h2 className="section-title">
                Pair Geography with Geography Current Affairs.
              </h2>
              <p className="section-text">
                Use this map with the Geography CA track for places, processes,
                and mapping examples under each topic.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/syllabus/environment" className="hero-btn-ghost">
                Environment map
                <span className="hero-btn-arrow" aria-hidden>
                  →
                </span>
