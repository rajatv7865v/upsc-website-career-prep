...
import { gs2SyllabusSections } from "@/data/gs2-syllabus";

export const metadata: Metadata = {
  title: "GS Paper 2 Syllabus | Syllabus & Pattern | Career Prepp",
  description:
    "Free UPSC GS Paper II syllabus breakdown — Constitution, governance, welfare, social sector, civil services, and India & the world.",
};
...
function sectionStats(section: (typeof gs2SyllabusSections)[number]) {
...
export default function GsPaper2Page() {
  const totalTopics = gs2SyllabusSections.reduce(
      ...
      <main className="flex-1">
        <section className="gs1-hero relative min-h-[88svh] overflow-hidden bg-black lg:min-h-[92svh]">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=2400&h=1350&q=90"
              alt="Constitution and governance study theme"
              fill
              priority
              quality={90}
          ...
          <div className="relative z-10 mx-auto flex min-h-[88svh] max-w-7xl flex-col justify-end px-6 pb-16 pt-28 sm:pb-20 lg:min-h-[92svh] lg:justify-center lg:px-8 lg:pb-24 lg:pt-24">
            <div className="gs1-hero-content max-w-3xl">
              ...
              <p className="gs1-hero-kicker">
                Syllabus &amp; Pattern · GS Paper II
              </p>

              <h1 className="gs1-hero-title">
                Constitution, governance, welfare &amp; India in the world —
                mapped for Mains.
              </h1>

              <p className="gs1-hero-text">
                A free, exam-ready syllabus atlas for UPSC CSE Mains GS Paper II,
                structured from the Mains decoded file with full topic
                checklists.
              </p>

              <div className="gs1-hero-actions">
                <a href="#gs2-map" className="hero-btn-primary footer-cta-shine">
                  Explore syllabus map
                  <IconArrow className="ml-2 inline h-4 w-4" />
                </a>
                <a
                  href="/file/GS-PAPER-2-SYLLABUS.docx"
                  download
        ...
        <nav className="gs1-rail sticky top-16 z-30 border-b border-line bg-white/92 backdrop-blur-md sm:top-[4.75rem]">
          <div className="mx-auto flex max-w-7xl items-center gap-3 overflow-x-auto px-6 py-3.5 lg:px-8">
            ...
            {gs2SyllabusSections.map((section, i) => (
              <a
                key={section.id}
                href={`#${section.id}`}
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
              <div className="section-head section-head-dark max-w-2xl">
                ...
                <h2 className="section-title">
                  Nineteen chapters. Full GS Paper II decoded map.
                </h2>
              ...
              <div className="gs1-preview-stats">
                <div>
                  <p className="gs1-stat-value">
                    {String(gs2SyllabusSections.length).padStart(2, "0")}
                  </p>
        ...
        {gs2SyllabusSections.map((section, sIndex) => {
        ...
        <section className="border-t border-line bg-black py-20 lg:py-28">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div className="section-head section-head-dark max-w-xl">
              ...
              <h2 className="section-title">
                Pair GS Paper II with GS Paper I and IR maps.
              </h2>
              <p className="section-text">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/syllabus/ir" className="hero-btn-ghost">
                IR syllabus
                <span className="hero-btn-arrow" aria-hidden>
                  →
                </span>
