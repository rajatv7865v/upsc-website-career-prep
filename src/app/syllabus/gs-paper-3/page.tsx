...
import { gs3SyllabusSections } from "@/data/gs3-syllabus";

export const metadata: Metadata = {
  title: "GS Paper 3 Syllabus | Syllabus & Pattern | Career Prepp",
  description:
    "Free UPSC GS Paper III syllabus breakdown — Indian economy, agriculture, infrastructure, science & technology, environment, disaster management, and internal security.",
};
...
function sectionStats(section: (typeof gs3SyllabusSections)[number]) {
...
export default function GsPaper3Page() {
  const totalTopics = gs3SyllabusSections.reduce(
      ...
      <main className="flex-1">
        <section className="gs1-hero relative min-h-[88svh] overflow-hidden bg-black lg:min-h-[92svh]">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=2400&h=1350&q=90"
              alt="Economy and development study theme for GS Paper III"
              fill
              priority
              quality={90}
          ...
          <div className="relative z-10 mx-auto flex min-h-[88svh] max-w-7xl flex-col justify-end px-6 pb-16 pt-28 sm:pb-20 lg:min-h-[92svh] lg:justify-center lg:px-8 lg:pb-24 lg:pt-24">
            <div className="gs1-hero-content max-w-3xl">
              ...
              <p className="gs1-hero-kicker">
                Syllabus &amp; Pattern · GS Paper III
              </p>

              <h1 className="gs1-hero-title">
                Economy, tech, environment &amp; security — mapped for Mains.
              </h1>

              <p className="gs1-hero-text">
                A free, exam-ready syllabus atlas for UPSC CSE Mains GS Paper III,
                structured from the GS3 Mains syllabus file with full topic
                checklists.
              </p>

              <div className="gs1-hero-actions">
                <a href="#gs3-map" className="hero-btn-primary footer-cta-shine">
                  Explore syllabus map
                  <IconArrow className="ml-2 inline h-4 w-4" />
                </a>
                <a
                  href="/file/GS-PAPER-3-SYLLABUS.docx"
                  download
        ...
        <nav className="gs1-rail sticky top-16 z-30 border-b border-line bg-white/92 backdrop-blur-md sm:top-[4.75rem]">
          <div className="mx-auto flex max-w-7xl items-center gap-3 overflow-x-auto px-6 py-3.5 lg:px-8">
            ...
            {gs3SyllabusSections.map((section, i) => (
              <a
                key={section.id}
                href={`#${section.id}`}
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
              <div className="section-head section-head-dark max-w-2xl">
                ...
                <h2 className="section-title">
                  Fourteen chapters. Full GS Paper III syllabus map.
                </h2>
              ...
              <div className="gs1-preview-stats">
                <div>
                  <p className="gs1-stat-value">
                    {String(gs3SyllabusSections.length).padStart(2, "0")}
                  </p>
        ...
        {gs3SyllabusSections.map((section, sIndex) => {
        ...
        <section className="border-t border-line bg-black py-20 lg:py-28">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div className="section-head section-head-dark max-w-xl">
              ...
              <h2 className="section-title">
                Pair GS Paper III with GS Paper 2 and IR maps.
              </h2>
              <p className="section-text">
                Use free syllabus pages together with Current Affairs tracks for
                examples and answer writing.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              ...
              <Link href="/syllabus/gs-paper-1" className="hero-btn-ghost">
                GS Paper 1
                <span className="hero-btn-arrow" aria-hidden>
                  →
                </span>
