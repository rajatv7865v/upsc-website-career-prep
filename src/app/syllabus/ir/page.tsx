...
import { irSyllabusSections } from "@/data/ir-syllabus";

export const metadata: Metadata = {
  title: "IR Syllabus | Syllabus & Pattern | Career Prepp",
  description:
    "Free International Relations syllabus map for UPSC — Indian foreign policy, bilateral relations, major powers, and multilateral institutions.",
};
...
export default function IrSyllabusPage() {
  return (
    <>
      <Header />
      ...
      <main className="flex-1">
        <section className="page-hero">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=2400&h=1200&q=80"
              alt="Earth from space — global relations"
              fill
              priority
              quality={80}
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
            <p className="section-label">Syllabus & Pattern · IR</p>
            <h1 className="page-hero-title">
              International Relations — free syllabus map.
            </h1>
            <p className="page-hero-text">
              A structured GS Paper II IR outline: Indian foreign policy,
              neighbourhood bilaterals, major powers, and multilateral
              institutions — ready for notes and revision.
            </p>
        ...
        <section className="border-b border-line bg-white py-10">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {irSyllabusSections.map((section) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="section-head">
              ...
              <h2 className="section-title">
                Five boxes that organise the full IR syllabus.
              </h2>
              <p className="section-text">
                Use this map to plan weekly notes. Each box expands into topic
                cards with checklist points from the IR syllabus file.
              </p>
            </div>

            <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
              {irSyllabusSections.map((section, i) => {
        ...
        {/* Detailed sections */}
        {irSyllabusSections.map((section, sIndex) => {
        ...
        <section className="border-t border-line bg-black py-20 lg:py-28">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div className="section-head section-head-dark max-w-xl">
              ...
              <h2 className="section-title">
                Pair this IR map with Current Affairs.
              </h2>
              <p className="section-text">
                Use Geography and Mains CA tracks to add fresh examples under
                each bilateral and institution block.
              </p>
            </div>
