...
import { economySyllabusSections } from "@/data/economy-syllabus";

export const metadata: Metadata = {
  title: "Economy Syllabus | Syllabus & Pattern | Career Prepp",
  description:
    "Free UPSC Economy syllabus map — microeconomics, money & banking, fiscal policy, markets, industry, agriculture, and social development.",
};
...
function sectionStats(section: (typeof economySyllabusSections)[number]) {
  const points = section.blocks.reduce((n, b) => n + b.points.length, 0);
  return { units: section.blocks.length, points };
}

export default function EconomySyllabusPage() {
  const totalPoints = economySyllabusSections.reduce(
      ...
      <main className="flex-1">
        <section className="gs1-hero relative min-h-[88svh] overflow-hidden bg-black lg:min-h-[92svh]">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=2400&h=1350&q=90"
              alt="Financial markets and Indian economy study theme"
              fill
              priority
              quality={90}
          ...
          <div className="relative z-10 mx-auto flex min-h-[88svh] max-w-7xl flex-col justify-end px-6 pb-16 pt-28 sm:pb-20 lg:min-h-[92svh] lg:justify-center lg:px-8 lg:pb-24 lg:pt-24">
            <div className="gs1-hero-content max-w-3xl">
              ...
              <p className="gs1-hero-kicker">
                Syllabus &amp; Pattern · Economy
              </p>

              <h1 className="gs1-hero-title">
                Indian economy — free syllabus map for Prelims &amp; Mains.
              </h1>

              <p className="gs1-hero-text">
                Micro to macro, banking to budget, industry to agriculture —
                structured topic checklists from the Economy syllabus file.
              </p>

              <div className="gs1-hero-actions">
                <a href="#economy-map" className="hero-btn-primary footer-cta-shine">
                  Explore syllabus map
                  <IconArrow className="ml-2 inline h-4 w-4" />
                </a>
                <a
                  href="/file/ECONOMY-SYLLABUS.docx"
                  download
        ...
        <nav className="gs1-rail sticky top-16 z-30 border-b border-line bg-white/92 backdrop-blur-md sm:top-[4.75rem]">
          <div className="mx-auto flex max-w-7xl items-center gap-3 overflow-x-auto px-6 py-3.5 lg:px-8">
            ...
            {economySyllabusSections.map((section, i) => (
              <a
                key={section.id}
                href={`#${section.id}`}
            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
              <div className="section-head section-head-dark max-w-2xl">
                ...
                <h2 className="section-title">
                  Fifteen chapters. Full Economy syllabus map.
                </h2>
                <p className="section-text">
                  Skim the atlas, then open a chapter for expandable topic
                  checklists taken directly from the Economy syllabus file.
                </p>
              </div>
              ...
              <div className="gs1-preview-stats">
                <div>
                  <p className="gs1-stat-value">
                    {String(economySyllabusSections.length).padStart(2, "0")}
                  </p>
        ...
        {economySyllabusSections.map((section, sIndex) => {
        ...
        <section className="border-t border-line bg-black py-20 lg:py-28">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div className="section-head section-head-dark max-w-xl">
              ...
              <h2 className="section-title">
                Pair Economy with GS Paper 3 and Current Affairs.
              </h2>
              <p className="section-text">
                Use this map with Mains GS III and Mains CA for examples under
                budget, inflation, and development topics.
              </p>
            </div>
